...
public class Basic_Information {
    ...
    public static final String DBURL
            = "jdbc:mysql://localhost:3306/BookManageSYS?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
    public static final String DBUSER = "root"; // MySQL用户名
    public static final String DBPASS = "050415";
