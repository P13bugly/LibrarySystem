...
public class MainInterface extends JFrame implements ActionListener {  //窗口,事件监听器
    ...
    public static NewClass newJPanel = new NewClass();           //新类别
    public static UpdateBook updateJPanel = new UpdateBook();    //更新书籍
    public static State_search stateJPanel = new State_search();               //书籍状态
    public static State_Output stateInfoJPanel = new State_Output();
    //User
    ...
    private static boolean flag_newClass = false;
    ...
    public void init(){
        ...
        //密码输入
        pf_password = new JPasswordField();       //隐藏密码
